...
const EN = {
  ...
  'संदेश सुझाव (सुविधा अनुसार चुनें)': 'Message Suggestions (Choose as needed)',
  'संदेश प्रीव्यू व संपादन (Live Preview & Edit)': 'Live Preview & Edit Message',
  'कॉपी करें': 'Copy', 'मोबाइल उपलब्ध नहीं': 'Mobile not available',
  'ग्राहक खाता विवरण': 'Customer Ledger Statement',
  'मासिक लाभ-हानि रिपोर्ट': 'Monthly Profit & Loss Report',
  'आइटम-वार मुनाफा': 'Item-wise Profit',
  'संदेश कॉपी हो गया': 'Message copied to clipboard',
  'मोबाइल नंबर नहीं है': 'Mobile number missing'
};

/* Demo/seed data (item names, categories, people) — for display */
const EN_DATA = {
  'मेरी दुकान': 'Salhotra Multi Store',
  'श्री बालाजी किराना स्टोर': 'Salhotra Multi Store',
  'मेन बाज़ार, लुधियाना, पंजाब': 'Main Bazaar, City', 'लुधियाना': 'City',
  ...
  'चीनी (Sugar)': 'Sugar', 'चावल बासमती (Rice)': 'Basmati Rice',
  'सरसों तेल 1L (Mustard Oil)': 'Mustard Oil 1L', 'चाय पत्ती 250g (Tea)': 'Tea Leaves 250g',
  'साबुन (Soap)': 'Soap',
  ...
  'रमेश कुमार (Ramesh)': 'Ramesh Kumar', 'सुरेश शर्मा (Suresh)': 'Suresh Sharma',
  'विकास वर्मा (Vikas)': 'Vikas Verma',
  ...
  'लोड हो रहा है...': 'Loading...', 'लोड हो रहा है': 'Loading...',
  'जाँच रहे हैं…': 'Checking…', 'गली नं. 1': 'Street No. 1', 'मेन रोड': 'Main Road', 'वार्ड 4': 'Ward 4'
};
